	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">
					<i class="fa fa-question-circle icon-title"></i> Help
				</h1>
		...
		<style type="text/css">
			...
			.card {
				...
				border: 0 solid rgb(39 197 230);
				border-radius: 5px;
				color: #fff;
				box-shadow: 0 20px 27px 0 rgb(0 0 0 / 5%);
				margin-bottom: 10px;
			}
			button.btn.btn-link:hover:focus-visible {
				font-size: 16px;
				font-weight: 500;
				color: #000;
		...
		<div class="row" style="display: flex;">
			<div class="col-md-4" style="display: flex;justify-content: center;">
				<img src="assets/images/svg/faq.svg" width="120%">
			</div>
			<div class="col-md-8">
