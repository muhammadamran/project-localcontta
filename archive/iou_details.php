                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="well">
                                ...
                                <?php include 'modals/iou_modal_act_create.php';?>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    // Check connection
                                      ...
                                      $result = mysqli_query($con,"SELECT * FROM tb_activity");
                                      ...
                                      if(mysqli_num_rows($result)>0){
...

                                          {
                                            ...
                                            <a href='#' data-toggle='modal' data-target='#pass$row[act_id]' title='Billing'><span class='label label-primary'>Billing</span></a>
