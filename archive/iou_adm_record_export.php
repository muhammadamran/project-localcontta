...
if(isset($_POST['delete']))
{
  ...
  if($rcd_id) {
    $query = mysql_query("DELETE FROM tb_master_export WHERE rcd_id = '$rcd_id' ");
    ...
    if($query){
      header("Location: ./iou_adm_record_export.php?DeleteSuccess=true");                                            
    } else {
      header("Location: ./iou_adm_record_export.php?DeleteFailed=true");                              
    }
  } else {
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">
          <i class="fas fa-tasks icon-title"></i> Record Management
        </h1>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="page-add">
              <form method="get" action="iou_adm_record_export.php" id="fformone" style="display: show;">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12" style="text-align: right;">
                    <a href="iou_adm_record_export.php" type="button" class="btn btn-info"><i class="fas fa-redo"></i> Reset</a>
                    <button type="submit" name="findone" id="idbtnfindone" class="btn btn-primary"><i class="fas fa-search"></i> Search</button>
                  </div>
                </div>
              </form>
              <form method="get" action="iou_adm_record_export.php" id="fformtwo" style="display: none;">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            $result = mysqli_query($con,"SELECT COUNT(*) AS total FROM tb_master_export");
            $cont_c = mysqli_fetch_array($result);
            ?>
            <div class="p-b-20" style="margin-bottom: 15px;">
              <div class="alert-info">
                <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
                <strong>Information!</strong> Total Record Management Export on Localcontta: <b><?= $cont_c['total'] ?> Record Management Export</b>.
                <p style="margin-bottom: 0px;">Record Management Export List on tables only shows the last 50 data, search Record Management Export' names if you can't find them in the table.</p>
              </div>
            </div>
            <div class="table-responsive">
              <table class="display hover" id="RecordManagementImport">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  if(isset($_GET['findone']))
                  {
                    $findREF = $_GET['findREF'];
                    $findAJU = $_GET['findAJU'];
                    $result = mysqli_query($con,"SELECT * FROM tb_master_export WHERE rcd_ref LIKE '%$findREF%' AND rcd_aju LIKE '%$findAJU%'");       
                  } else if(isset($_GET['findtwo'])) {
                    $startdate = $_GET['startdate'];
                    $enddate = $_GET['enddate'];
                    $result = mysqli_query($con,"SELECT * FROM tb_master_export WHERE rcd_create_date BETWEEN '$startdate' AND '$enddate'");  
                  } else {
                    $result = mysqli_query($con,"SELECT * FROM tb_master_export ORDER BY rcd_id DESC LIMIT 50");   
                  }
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title"><b>[Delete]</b> Record Management Export - <?= $row['rcd_id'] ?></h4>
                            </div>
                              ...
                              <div class="modal-body">
                                <div class="alert-delete">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                      <label class="blink_me">Type: <?= $row['rcd_type'] ?></label>
                                    </div>
                                  </div>
                                </div>
                              </div>
...
<script type="text/javascript">
    ...
    if (window?.location?.href?.indexOf('CaddSuccess') > -1) {
      ...
      history.replaceState({}, '', './iou_adm_record_export.php');
    }
