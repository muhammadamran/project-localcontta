...
if(isset($_POST['delete']))
{
  ...
  if($rcd_id) {
    ...
    if($query){
      header("Location: ./iou_adm_record_import.php?DeleteSuccess=true");                                            
    } else {
      header("Location: ./iou_adm_record_import.php?DeleteFailed=true");                              
    }
  } else {
  ...
  <div id="page-wrapper">
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="page-add">
              <form method="get" action="iou_adm_record_import.php" id="fformone" style="display: show;">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12" style="text-align: right;">
                    <a href="iou_adm_record_import.php" type="button" class="btn btn-info"><i class="fas fa-redo"></i> Reset</a>
                    <button type="submit" name="findone" id="idbtnfindone" class="btn btn-primary"><i class="fas fa-search"></i> Search</button>
                  </div>
                </div>
              </form>
              <form method="get" action="iou_adm_record_import.php" id="fformtwo" style="display: none;">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <i class="fa fa-table"></i> Import List
          </div>
          <div class="panel-body">
            <?php
            ...
            <div class="p-b-20" style="margin-bottom: 15px;">
              <div class="alert-info">
                ...
                <strong>Information!</strong> Total Record Management Import on Localcontta: <b><?= $cont_c['total'] ?> Record Management Import</b>.
                <p style="margin-bottom: 0px;">Record Management Import List on tables only shows the last 50 data, search Record Management Import' names if you can't find them in the table.</p>
              </div>
            </div>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title"><b>[Delete]</b> Record Management Import - <?= $row['rcd_id'] ?></h4>
                            </div>
...
<script type="text/javascript">
    ...
    if (window?.location?.href?.indexOf('CaddSuccess') > -1) {
      ...
      history.replaceState({}, '', './iou_adm_record_import.php');
    }
