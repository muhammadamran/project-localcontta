...
if (isset($_POST["create"])) {
  ...
  if ($vald_d == NULL) {
    ...
    if ($query) {
      header("Location: ./iou_adm_remarks_im_prec.php?DaddSuccess=true");
    } else {
      header("Location: ./iou_adm_remarks_im_prec.php?DaddFailed=true");
    }
  } else {
    header("Location: ./iou_adm_remarks_im_prec.php?DaddReady=true");
  }
}
...
if (isset($_POST["delete"])) {
  ...
  if ($query) {
    header("Location: ./iou_adm_remarks_im_prec.php?DeleteSuccess=true");
  } else {
    header("Location: ./iou_adm_remarks_im_prec.php?DeleteFailed=true");
  }
}
?>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            $result = mysqli_query($con, "SELECT COUNT(*) AS total FROM tb_remarks WHERE status='Pre-Clearance' AND type='import'");
            ...
            <div class="table-responsive">
              <table class="display hover" id="document">
                ...
                <tbody>
                  ...
                  $result = mysqli_query($con, "SELECT * FROM tb_remarks WHERE status='Pre-Clearance' AND type='import' ORDER BY id");
...
<script type="text/javascript">
  ...
  if (window?.location?.href?.indexOf('DaddSuccess') > -1) {
    ...
    history.replaceState({}, '', './iou_adm_remarks_im_prec.php');
  }
