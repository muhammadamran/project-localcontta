...
if (isset($_POST["create"])) {
  ...
  if ($vald_d == NULL) {
    ...
    if ($query) {
      header("Location: ./iou_adm_remarks_ex_prec.php?DaddSuccess=true");
    } else {
      header("Location: ./iou_adm_remarks_ex_prec.php?DaddFailed=true");
    }
  } else {
    header("Location: ./iou_adm_remarks_ex_prec.php?DaddReady=true");
  }
}
...
if (isset($_POST["delete"])) {
  ...
  if ($query) {
    header("Location: ./iou_adm_remarks_ex_prec.php?DeleteSuccess=true");
  } else {
    header("Location: ./iou_adm_remarks_ex_prec.php?DeleteFailed=true");
  }
}
?>
      ...
      <div class="col-lg-12">
        ...
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Remarks Pre-Clearance</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <i class="fa fa-table"></i> Remarks Pre-Clearance
          </div>
          <div class="panel-body">
            <div class="page-add">
              ...
              <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#add-Data">
                <i class="fas fa-plus-circle"></i> Add Remarks Pre-Clearance
              </button>
              <!-- Modal content-->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title"><b>[Add] </b> Remarks Pre-Clearance</h4>
                    </div>
            ...
            $result = mysqli_query($con, "SELECT COUNT(*) AS total FROM tb_remarks WHERE status='Pre-Clearance' AND type='export'");
            $cont_c = mysqli_fetch_array($result);
            ?>
            <div class="p-b-20" style="margin-bottom: 15px;">
              <div class="alert-info">
                <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                <strong>Information!</strong> Total Remarks Pre-Clearance on Localcontta: <b><?= $cont_c['total'] ?> Remarks Pre-Clearance</b>.
                <p style="margin-bottom: 0px;">Remarks Pre-Clearance List on tables only shows the last 50 data, search Remarks Pre-Clearance' names if you can't find them in the table.</p>
              </div>
            </div>
            <div class="table-responsive">
              <table class="display hover" id="document">
                ...
                <tbody>
                  ...
                  $result = mysqli_query($con, "SELECT * FROM tb_remarks WHERE status='Pre-Clearance' AND type='export' ORDER BY id");
                      ...
                      <div class="modal fade" id="edit<?= $row['id']; ?>" role="dialog">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title"><b>[Edit] </b> Remarks Pre-Clearance</h4>
                            </div>
                            <form method="post" action="">
                              <div class="modal-body">
                                <div class="row">
                      ...
                      <div class="modal fade" id="delete<?= $row['id']; ?>" role="dialog">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title"><b>[Delete]</b> Remarks Pre-Clearance</h4>
                            </div>
                            <form method="post" action=" ">
                              <div class="modal-body">
...
<script type="text/javascript">
  ...
  if (window?.location?.href?.indexOf('DaddSuccess') > -1) {
    ...
    history.replaceState({}, '', './iou_adm_remarks_ex_prec.php');
  }
