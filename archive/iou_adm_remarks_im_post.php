...
if (isset($_POST["create"])) {
  ...
  if ($vald_d == NULL) {
    ...
    if ($query) {
      header("Location: ./iou_adm_remarks_im_post.php?DaddSuccess=true");
    } else {
      header("Location: ./iou_adm_remarks_im_post.php?DaddFailed=true");
    }
  } else {
    header("Location: ./iou_adm_remarks_im_post.php?DaddReady=true");
  }
}
...
if (isset($_POST["delete"])) {
  ...
  if ($query) {
    header("Location: ./iou_adm_remarks_im_post.php?DeleteSuccess=true");
  } else {
    header("Location: ./iou_adm_remarks_im_post.php?DeleteFailed=true");
  }
}
?>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            $result = mysqli_query($con, "SELECT COUNT(*) AS total FROM tb_remarks WHERE status='Post-Clearance' AND type='import'");
            ...
            <div class="table-responsive">
              <table class="display hover" id="document">
                ...
                <tbody>
                  ...
                  $result = mysqli_query($con, "SELECT * FROM tb_remarks WHERE status='Post-Clearance' AND type='import' ORDER BY id");
...
<script type="text/javascript">
  ...
  if (window?.location?.href?.indexOf('DaddSuccess') > -1) {
    ...
    history.replaceState({}, '', './iou_adm_remarks_im_post.php');
  }
